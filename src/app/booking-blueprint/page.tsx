...
function BookingBlueprintContent() {
  ...
  const calendlyBaseUrl = 'https://calendly.com/wb-props/homeflip-blueprint';
    ...
    const handleMessage = (event: MessageEvent) => {
      if (event.data.event === 'calendly.event_scheduled') {
        ...
        sendConversionEvent({
          ...
          firstName,
          lastName,
          contentName: 'homeflip-blueprint',
        });
      }
    };
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-300 max-w-2xl mx-auto">
              A free 15-minute session to review your survey answers, discuss your investing goals, and map out your next steps with probate leads.
            </p>
          </motion.div>
...
export default function BookingBlueprintPage() {
  return (
