...
function PreStrategySurveyContent() {
  ...
  // Hide hero when user moves past page 0
  ...
  return (
    <>
      ...
      {/* Hero Section - Dark */}
      <section className="relative pt-28 pb-12 px-6 overflow-hidden bg-[#050505] min-h-screen">
        {/* Background Decor */}
        ...
        {/* Header - Hidden once survey starts */}
        <AnimatePresence>
          {showHero && (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              className="relative max-w-3xl mx-auto text-center mb-8"
            >
              <h1 className="font-hero font-[900] text-4xl sm:text-5xl md:text-6xl text-white uppercase tracking-tighter leading-[0.9] mb-6 whitespace-nowrap">
                Probate Investing{' '}
              ...
              <p className="text-xl md:text-2xl text-slate-300">
                Answer a few quick questions so we can make the best use of our time on the call.
              </p>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        >
          <PreStrategySurveyForm onPageChange={handlePageChange} />
        </motion.div>
      </section>
    </>
  );
