...
function BookingActivationContent() {
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-300 max-w-2xl mx-auto">
              A quick 15-minute call to confirm your county selection, answer any questions, and get your account activated.
            </p>
          </motion.div>
...
export default function BookingActivationPage() {
  return (
