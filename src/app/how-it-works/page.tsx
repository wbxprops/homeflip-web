          ...
          {deepDiveSteps.map((step, i) => (
            <Section key={i} className={i % 2 === 1 ? "bg-slate-50/50" : "bg-transparent"}>
              <div className={`flex flex-col ${i % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-16 lg:gap-24`}>
                ...
                <div className="flex-1 w-full aspect-[4/3] bg-slate-50 rounded-[3rem] border border-slate-200 overflow-hidden shadow-2xl relative group">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-slate-200 font-black text-6xl rotate-12 tracking-tighter opacity-10 uppercase">
                      Visualization
                    </div>
                  </div>
                  {/* Decorative element */}
                  <div className="absolute bottom-8 left-8 right-8 p-6 bg-white rounded-2xl border border-slate-100 shadow-sm">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-lg bg-[#0891b2] animate-pulse shadow-lg shadow-[#0891b2]/20" />
